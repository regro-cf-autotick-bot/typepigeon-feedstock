...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/typepigeon-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15605&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/typepigeon-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `typepigeon` can be installed with:

```
conda install typepigeon
```

It is possible to list all of the versions of `typepigeon` available on your platform with:
